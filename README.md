...
The psychologist can **listen to the user’s voice, understand the message, and respond verbally in real time**, creating an immersive and natural conversational experience.
...
- Use **Convai’s built-in AI system** without external backends
